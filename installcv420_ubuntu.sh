...
# CHECK WITH nproc LINUX COMMAND HOW MANY CORES YOU HAVE AND REPLACE THE NUMBER WITH IT.
make -j4
sudo make install

# THIS UPDATES the LD_LIBRARY_PATH. AFTER FINISHING CHECK THAT THE PATH BELOW REALLY IS THERE.
sudo ldconfig
